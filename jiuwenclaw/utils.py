...
def get_shared_agent_skills_dirs() -> list[Path]:
    """Return extra shared skill directories from environment configuration."""
...
def get_agent_registered_skill_dirs() -> list[Path]:
    """Return all skill directories the main agent should expose."""
...
def reset_free_search_runtime_flags() -> None:
    """Disable free-search engines at process start unless explicitly re-enabled."""

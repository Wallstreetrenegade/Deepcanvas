...
FEATURE_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "app_builder": {
        ...
        "description": "AI website/app builder with virtual files, preview mode, builder chat, saved projects, disk export, command runner, dev server, screenshot QA, plans, and zip artifacts.",
    },
    "crm": {
        "label": "CRM",
        "status": "live_state",
...
FEATURE_TOOLS = [
    features_catalog,
    features_overview,
    features_settings_status,
    features_state_get,
    features_storage_summary,
    ...
    features_project_flow_connect_nodes,
    features_project_flow_delete_edge,
    features_creative_studio_summary,
    features_creative_studio_set_template,
    features_creative_studio_update_brief,
    features_creative_studio_add_asset_request,
    features_creative_studio_update_asset_request,
    ...
    features_social_overview,
    features_social_larry_summary,
    features_social_larry_update_config,
    features_social_larry_toggle_auto,
    features_app_builder_summary,

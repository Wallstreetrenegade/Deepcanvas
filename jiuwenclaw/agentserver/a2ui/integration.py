...
"""Integration helpers for wiring A2UI into Deepcanvas/JiuwenClaw host modules.
...
from jiuwenclaw.agentserver.a2ui.config import get_a2ui_config, get_current_a2ui_config
...
def _build_a2ui_client_event_prompt(content: dict[str, Any], channel: str, language: str) -> str:
    ...
    from jiuwenclaw.agentserver.a2ui.runtime.prompt import build_a2ui_client_event_prompt
...
async def finalize_assistant_response_if_a2ui(
    ...
    *,
    ...
    from jiuwenclaw.agentserver.a2ui.runtime.response_finalization import finalize_a2ui_assistant_content

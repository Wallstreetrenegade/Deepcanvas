...
from jiuwenclaw.agentserver.a2ui.parser import (
    coerce_message_list,
    may_contain_a2ui_content,
    parse_a2ui_response,
)
from jiuwenclaw.agentserver.a2ui.prompt_instructions import build_a2ui_autonomy_instruction
from jiuwenclaw.agentserver.a2ui.stream_guard import A2UIStreamGuard
from jiuwenclaw.agentserver.a2ui.text_formatter import format_for_text_channel
from jiuwenclaw.agentserver.a2ui.types import A2UIExample, A2UIResponsePart, A2UIValidationResult
from jiuwenclaw.agentserver.a2ui.validator import (
...
def _normalize_prompt_contract(prompt: str) -> str:
    """Remove SDK default wording that conflicts with the local v0.8 contract."""
...
class A2UIProtocolSpec:
    ...
    def build_prompt(self, language: str = "en") -> str:
        role = (
            ...
            "interactive answer is appropriate, generate messages that strictly "
            "validate against the A2UI 0.8 schema."
        )
        ui = (
            "Use A2UI for lists, cards, forms, confirmations, clickable actions, "
            "and structured comparisons. Keep ordinary explanations, short "
            "answers, sensitive answers, and non-interactive replies as plain text."
        )
        workflow = (
            ...
            "needed. List parent components before child components. Do not emit "
            "schema, fields, or components from any protocol version other than "
            "0.8."
        )

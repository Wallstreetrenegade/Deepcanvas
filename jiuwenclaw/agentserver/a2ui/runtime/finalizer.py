...
from jiuwenclaw.agentserver.a2ui.protocol import A2UI_OPEN_TAG, get_protocol_spec
...
def _a2ui_failure_text(content: str, validation_error: str) -> str:
    ...
    if readable:
        return readable
    _ = validation_error
    return "The generated interface could not be validated. Please try again or describe the request another way."

...
"""Runtime build context for provider-based team/swarm assembly."""
...
class SwarmBuildContext(BuildContext):
    """BuildContext subclass carrying live Deepcanvas swarm runtime handles.

    The object is attached to team specs while they are built. Serializable
    fields can be exported as a seed and rebuilt later; live handles such as
    ``config`` and ``trajectory_registry`` are supplied by the receiving process.
    """

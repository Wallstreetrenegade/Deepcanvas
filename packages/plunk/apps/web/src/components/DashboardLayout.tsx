...
export function DashboardLayout({children}: DashboardLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-neutral-50">
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed inset-y-0 right-0 z-50 w-64 bg-white transform transition-transform duration-300 ease-in-out lg:hidden ${
      ...
      <div className="hidden lg:flex w-64 bg-white border-l border-neutral-200 flex-col">
